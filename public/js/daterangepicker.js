...
}(function ($, moment)
{
 ...
 $.dateRangePickerLanguages =
 {
  'az':
  {
   ...
   'less-than' : 'Tarix aral??? %d günd?n çox olmamal?d?r',
   'more-than' : 'Tarix aral??? %d günd?n az olmamal?d?r',
   'default-more' : '%d günd?n çox bir tarix seçin',
   'default-single' : 'Tarix seçin',
   'default-less' : '%d günd?n az bir tarix seçin',
   'default-range' : '%d v? %d gün aral???nda tarixl?r seçin',
   'default-default': 'Tarix aral??? seçin'
  },
  'cn':
  {
   'selected': '???:',
  ...
  'cz':
  {
   ...
   'week-6' : 'so',
   'week-7' : 'ne',
   'month-name': ['leden','únor','b?ezen','duben','kv?ten','?erven','?ervenec','srpen','zá?í','?íjen','listopad','prosinec'],
   'shortcuts' : 'Zkratky',
   'past': 'po',
   ...
   'next-month':'m?síc',
   'next-year':'rok',
   'less-than' : 'Rozsah data by nem?l být v?tší než %d dn?',
   'more-than' : 'Rozsah data by nem?l být menší než %d dn?',
   'default-more' : 'Prosím zvolte rozsah data v?tší než %d dn?',
   'default-single' : 'Prosím zvolte datum',
   'default-less' : 'Prosím zvolte rozsah data menší než %d dn?',
  ...
  'hu':
  {
   ...
   'default-more' : 'Válassz ki egy id?szakot ami hosszabb mint %d nap',
   'default-single' : 'Válassz egy napot',
   'default-less' : 'Válassz ki egy id?szakot ami rövidebb mint %d nap',
   'default-range' : 'Válassz ki egy %d - %d nap hosszú id?szakot',
   'default-default': 'Válassz ki egy id?szakot'
  }
 };
